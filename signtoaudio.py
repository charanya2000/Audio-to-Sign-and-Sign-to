...
class Application:
    ...
    def __init__(self):
        ...
        self.model = load_model(os.path.join(PROJECT_PATH, 'models', 'cnn8grps_rad1_model.h5'))
        ...
        self.root.title("Sanket")
        self.root.geometry("1490x830+290+140")
        self.root.resizable(True, True)
        self.root.config(bg="#97a3a9")

        self.engine = pyttsx3.init()

        self.panel = tk.Label(self.root)
        self.panel.place(x=20, y=80, width=480, height=480)

        self.panel2 = tk.Label(self.root)
        self.panel2.place(x=520, y=80, width=400, height=400)

        self.panel3 = tk.Label(self.root)  # Current Symbol
        self.panel3.place(x=700, y=485)

        self.T1 = tk.Label(self.root)
        self.T1.place(x=520, y=480)
        self.T1.config(text="Character :", bg="#97a3a9",font=("Courier", 20, "bold"))

        self.panel5 = tk.Label(self.root)  # Sentence
        self.panel5.place(x=700, y=532)

        self.T3 = tk.Label(self.root)
        self.T3.place(x=520, y=532)
        self.T3.config(text="Sentence :", bg="#97a3a9", font=("Courier", 20, "bold"))

        self.newspeak = tk.PhotoImage(file=PROJECT_PATH+"/images/newspeak.png")
        self.clearimage = tk.PhotoImage(file=PROJECT_PATH+"/images/clear.png")
        self.speak = tk.Button(self.root,image=self.newspeak,bg="#97a3a9",bd=0)
        self.speak.place(x=550, y=630)
        self.speak.config(text="Speak", font=("Courier", 20), wraplength=100, command=self.speak_fun)

        self.clear = tk.Button(self.root,image=self.clearimage,bg="#97a3a9",bd=0)
        self.clear.place(x=770, y=630)
        ...
        try:
            ...
            if cv2image.any:
                ...
                if hands[0]:
                    ...
                    import os
                    white = cv2.imread(os.path.join(PROJECT_PATH, "images", "white.jpg"))
                    ...
                    if image.all:
                        ...
                        if handz[0]:
                            ...
                            self.panel3.config(text=self.current_symbol, bg="#97a3a9", font=("Courier", 20))


                self.panel5.config(text=self.str,  bg="#97a3a9",font=("Courier", 20), wraplength=1025)
        except Exception:
